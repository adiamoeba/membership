...
define('SLIMS_DB_NAME', 'slims9_bulian');   // nama database SLiMS Anda
define('SLIMS_DB_USER', 'slims_readonly');  // sebaiknya user dengan hak SELECT saja
define('SLIMS_DB_PASS', 'password_readonly');
...
define('APP_DB_NAME', 'membership_app');
define('APP_DB_USER', 'membership_user');
define('APP_DB_PASS', 'password_app');
